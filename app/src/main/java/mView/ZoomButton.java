...
public class ZoomButton extends Button {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.ZoomButton);
            color = a.getColor(R.styleable.ZoomButton_cb_color, color);
            pressedRingWidth = (int) a.getDimension(R.styleable.ZoomButton_cb_pressedRingWidth, pressedRingWidth);
            a.recycle();
        }
